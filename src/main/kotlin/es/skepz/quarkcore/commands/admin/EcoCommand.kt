...
class EcoCommand(val core: QuarkCore) : CoreCMD(core, "eco", "/eco <give|take|set> <player> <amount>",
    0, "quark.eco", false, true) {
    ...
    override fun registerTabComplete(sender: CommandSender, args: Array<String>): List<String> {
        ...
        if (args.size == 1) {
            StringUtil.copyPartialMatches(args[0], listOf("set", "give", "take"), completions)
        } else if (args.size == 2) {
